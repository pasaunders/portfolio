(function(module) {
  ...
  aboutView.moreLessHandler = function () {  //uses jQuery to allow the user to expand and contract articles by clicking a div, then changes the div to say more or less
  ...
  // aboutView.filterHandler = function () { //incomplete handler for filtering articles based on medium and genre properties
  ...
  aboutView.moreLessHandler();
  // aboutView.filterHandler();
})(window);
